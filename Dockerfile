...
LABEL maintainer="Aleari" git="https://github.com/AleariSolutions"
LABEL contact="contato@alearisolutions.com.br"
...
ENV REDIS_URI='redis://default:K3mt8{5tEp-jq[{e@aleari-typebot_evolution-api-redis:6379'
...
ENV CONFIG_SESSION_PHONE_CLIENT='Aleari Online'
...
ENV AUTHENTICATION_JWT_SECRET='L=rtWt]bvw[WF>#>:23`'
